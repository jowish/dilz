...
const PROFILE_TEXT = {
  en: { profile: 'Profile', back: 'Back', signOut: 'Sign out', posted: 'Deals posted', received: 'Hot votes received', settings: 'Account settings', settingsHelp: 'Choose how Dilz should look when you return.', language: 'Language', theme: 'Appearance', light: 'Light', dark: 'Dark', warm: 'Warm', system: 'System', feedOrder: 'Default feed order', english: 'English', hebrew: 'Hebrew', hot: 'Hottest first', latest: 'Newest first', comments: 'Most commented', saved: 'Preference saved', mine: 'My deals', loading: 'Loading...', empty: 'No deals yet', emptyText: 'Share a deal you spotted!', post: 'Post a deal', now: 'Just now', hour: 'h ago', day: 'd ago', legal: 'Legal and privacy', privacy: 'Privacy Policy', terms: 'Terms of Use', danger: 'Delete account', dangerHelp: 'Permanently delete your account and private data. Your public contributions will be anonymized.', delete: 'Delete my account', confirmTitle: 'This action cannot be undone', confirmHelp: 'Type DELETE to permanently delete your Dilz account.', confirmWord: 'DELETE', cancel: 'Cancel', deleting: 'Deleting...', deleteError: 'Account deletion failed. Please try again or contact support.' },
  he: { profile: 'פרופיל', back: 'חזרה', signOut: 'התנתקות', posted: 'דילים שפורסמו', received: 'הצבעות חמות שהתקבלו', settings: 'הגדרות חשבון', settingsHelp: 'בחרו כיצד Dilz יוצג בכל כניסה.', language: 'שפה', theme: 'מראה', light: 'בהיר', dark: 'כהה', warm: 'חמים', system: 'לפי המערכת', feedOrder: 'סדר ברירת מחדל בפיד', english: 'אנגלית', hebrew: 'עברית', hot: 'החמים ביותר', latest: 'החדשים ביותר', comments: 'עם הכי הרבה תגובות', saved: 'ההעדפה נשמרה', mine: 'הדילים שלי', loading: 'טוען...', empty: 'עדיין אין דילים', emptyText: 'שתפו דיל שמצאתם!', post: 'פרסום דיל', now: 'עכשיו', hour: 'ש׳', day: 'י׳' },
};
      ...
      <div className="dilz-profil-page" dir={dir}>
        ...
        <main className="dilz-profil-main">
          ...
          <section id="settings" className="dilz-account-settings" aria-labelledby="account-settings-title">
            ...
            <fieldset className="dilz-preference-group">
              <legend>{text.theme || 'Appearance'}</legend>
              <div className="dilz-preference-options">
                {THEME_VALUES.map((value) => (
                  <button key={value} type="button" className={themePreference === value ? 'is-selected' : ''} aria-pressed={themePreference === value} onClick={() => changeThemePreference(value)}>
                    {text[value] || value}
                  </button>
                ))}
              </div>
